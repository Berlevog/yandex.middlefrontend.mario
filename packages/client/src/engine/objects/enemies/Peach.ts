...
export default class Peach extends PhysicalObject {
	public type = Engine.ObjectType.BOSS;
	...
	constructor(props: DwarfProps) {
		super({ ...props, texture: new ResourceImage("images/peach.png") });
	...
	* getRunningTexture() {
		while (true) {
			yield [0, 0, this.width, this.height];
